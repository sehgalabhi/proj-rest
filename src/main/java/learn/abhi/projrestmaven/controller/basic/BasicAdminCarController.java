...
@RestController
@AllArgsConstructor
@RequestMapping("/admin/basic/cars")
@Slf4j
public class BasicAdminCarController {
    ...
    public ResponseEntity<CarCreationResponse> createCars(@Validated @RequestBody CarCreationRequest carCreationRequest){
        log.info("Called post admin cars for Basicontroller");
    ...
    public ResponseEntity<List<Car>> getCars(){
        log.info("Called get admin cars for Basicontroller");
